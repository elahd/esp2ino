...
static esp_err_t doFlash(httpd_req_t *req)
{
   ...
   * */
    ...
    //   ESP32 TO-DO
    //   NEED TO MAKE ERRORS HERE OUTPUT TO WEB
    ...
    while (attempt <= 4)
    {
        ...
        else
        {
            ...
            webui_msgPub(req, "1", FLASH_STATE_FAIL, "Failed while installing firmware. This should be recoverable. Try again after verifying that your "
                                                     ...
                                                     "Reverting to this overwritten firmware will brick your device. You can reboot / power cycle your device if needed.");
...
void app_main()
{
    ...
    // TO-DO: Use esp_partition_find to confirm assumptions about flash layout and to get actual chip size.
    ...
    {
    // ESP8266_RTOS_SDK enumerates 0 as ESP8266. ESP-IDF does not.
    // TO-DO: Expand to handle or fail on other chips (ESP32-S2)
    // case 0:
